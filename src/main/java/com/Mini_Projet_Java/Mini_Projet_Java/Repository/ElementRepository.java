...
public interface ElementRepository extends JpaRepository<Element, Long> {
	@Query("SELECT new com.Mini_Projet_Java.Mini_Projet_Java.DTO.ElementDTO(e.id, e.nomElement, e.coefficient, " +
    ...
    List<ElementDTO> findElementsByProfesseurId(Long profId);
}
